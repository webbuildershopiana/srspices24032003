...
const Header = ({ layout }: { layout: string }) => {
  ...
  return ( 
    ...
    <div data-gjs-type="ui-header" id="i2ook"><nav className="w-100 navbar navbar-expand-lg navbar-light" id="i4cze"><div className="container-fluid" id="i760k"><div className="hamburger1"><span className="bar1"></span><span className="bar1"></span><span className="bar1"></span></div><section className="p-0" id="i8kyzvg"><Link className="navbar-brand" href="/index" id="iwn4j" link-type="page" name="index" page="page://Fgelthl8WxI1Pwnu" slug="index"><img alt="Image" className="img-fluid" id="isulcsl" src="https://d1ne4tihfhyh93.cloudfront.net/files/srspices24032003/ASSET/WhatsApp Image 2024-05-21 at 12.28.44.jpeg"/></Link></section><div className="collapse navbar-collapse" id="collapseId"><div className="navbar-nav" id="i4ty2"><Link className="nav-item nav-link active" href="/index" id="ip927" link-type="page" name="index" page="page://Fgelthl8WxI1Pwnu" slug="index">Home</Link><Link className="nav-item nav-link active" href="/recipe" id="irfvfcc" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Categories</Link><Link className="nav-item nav-link active" href="/about-page" id="igio6" link-type="page" name="About Page" page="page://wAW6gTheuhIDxBMwTTu" slug="about-page">About Us</Link><Link className="nav-item nav-link active" href="/contact-page" id="icpyl" link-type="page" name="Contact page" page="page://So8kNVmmIIQJXeWaO9jL" slug="contact-page">Contact Us</Link><Link className="nav-item nav-link active" href="/recipe" id="ir3y1mf" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Recipe</Link><Link className="nav-item nav-link active" href="/recipe" id="i16xhe6" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Infrastructure</Link><Link className="nav-item nav-link active" href="/recipe" id="ihag1si" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Quality Assurance</Link><Link className="nav-item nav-link active" href="/recipe" id="i7gh43j" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Bulk Order</Link><Link className="nav-item nav-link active" href="/recipe" id="ind1lyd" link-type="page" name="Recipe" page="page://uEy3N9ExMi39fiYEqFiaU" slug="recipe">Brochure</Link><div className="nav-item dropdown"><div className="dropdown-menu"><a className="dropdown-item" href="#">Inbox</a><a className="dropdown-item" href="#">Sent</a><a className="dropdown-item" href="#">Drafts</a></div></div></div><div className="navbar-nav ms-auto" id="iuulh"><div action-type="add-cart" button-type="cart" id="iaq3o"><button id="ic5ei" type="button">Cart</button></div><div action-type="sign-in" button-type="auth" id="it5xwp">
                    {
