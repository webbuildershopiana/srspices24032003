...
const OrderCard: React.FC<OrderCardProps> = ({ onClick, order, isActive }) => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center flex-col border-b border-border-200 p-0 m-4 py-2 px-3 md:px-2 lg:px-3 text-center ">
        ...
        <span
          className="text-sm text-blue-500 bg-blue-100 px-3 py-2 rounded whitespace-nowrap w-40"
          title={status?.name}
        >
          {status?.name}
        </span>
