  ...
  return (
    <section className="flex flex-col h-full relative">
      ...
      <footer className="fixed bottom-0 w-full max-w-md py-5 px-6 z-10 bg-light">
        <Button
          className="flex justify-between w-full h-12 md:h-14 p-1 text-sm font-bold bg-accent rounded-full shadow-700 transition-colors focus:outline-none hover:bg-accent-hover hover:text-light-hover focus:bg-accent-hover"
          onClick={handleCheckout}
          disabled={isEmpty}
        >
          <span className="flex flex-1 items-center h-full px-5">
