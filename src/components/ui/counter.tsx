  ...
  return (
    ...
    >
      <button
        onClick={onDecrement}
        className={cn(
          'cursor-pointer p-2 transition-colors duration-200 hover:bg-accent-hover focus:outline-none hover:text-light-hover',
          {
      ...
      >
        <span className="sr-only">{STATIC_CONTENT['text-minus']}</span>
      ...
      <button
        ...
        title={disabled ? STATIC_CONTENT['text-out-stock'] : ''}
      >
