      ...
      >
        ...
        <p className="mt-4 text-center text-sm text-body">
          <span className="font-semibold text-accent">
            {STATIC_CONTENT['text-upload-highlight']}
          </span>{' '}
          {STATIC_CONTENT['text-upload-message']} <br />
          <span className="text-xs text-body">{STATIC_CONTENT['text-img-format']}</span>
        </p>
      </div>
      ...
      <aside className="mt-2 flex flex-wrap">
        ...
        {isLoading && (
          <div className="mt-2 flex h-16 items-center ltr:ml-2 rtl:mr-2">
            <Spinner
              text={STATIC_CONTENT['text-loading']}
              simple={true}
              className="h-6 w-6"
            />
          </div>
