    ...
    <>
      ...
      >
        <Link
          ...
          href={item.children.length > 0 ? `categories?category=${item?.slug}` : item.href}
        >
          {icon && (
          ...
          {icon === "" && <span className="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"></span>}
          <span>{name}</span>
