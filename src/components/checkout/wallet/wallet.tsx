    ...
    <div>
      <div className="mt-2 space-y-2">
        ...
        <div className="flex justify-between text-sm text-body">
          <span>
            {STATIC_CONTENT['text-wallet']}{' '}
            <span className="lowercase">{STATIC_CONTENT['text-points']}</span>
          </span>
          <span>{walletAmount}</span>
        </div>
        <div className="flex justify-between text-sm text-body">
          <span>
            {STATIC_CONTENT['text-wallet']} {STATIC_CONTENT['text-currency']}
          </span>
      ...
      <Checkbox
        name="use_wallet"
        label={STATIC_CONTENT['text-wallet-use']}
        className="mt-3"
