...
import GroupProductsGrid from '@/components/group-products/group-products-grid';
    ...
    <Fragment>
      <div className="flex flex-col items-center">
        <h1 className="mb-4 text-2xl font-bold text-accent sm:text-3xl lg:text-4xl">
          {STATIC_CONTENT['text-product-groups']}
        </h1>
        {/* <p className="text-base text-heading">
          {STATIC_CONTENT['text-search-manufacturers-subtitle']}
        </p> */}
        ...
        <div className="mt-12 w-full max-w-screen-md">
          <Search
            variant="minimal"
            label="search"
            placeholder={STATIC_CONTENT['text-search-product-groups']}
          />
        </div>
      </div>
      <GroupProductsGrid />
...
GroupProductsPage.getLayout = getLayout;
