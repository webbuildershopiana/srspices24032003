...
interface CartProviderState extends State {
  ...
  addItemToCartAuth: (item: Item, quantity: number) => void;
...
export const CartProvider: React.FC = (props) => {
  ...
  const addItemToCartAuth = (item: Item, quantity: number) =>
    dispatch({ type: 'ADD_ITEM_WITH_QUANTITY_AUTH', item, quantity });
